...
class LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Consumer<AuthProvider>(builder: (BuildContext ctx, provider, Widget? widget){
        return SafeArea(
          child: Stack(
            children: [
              Stack(
                                    ...
                                    if (formKey.currentState!.validate()) {
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text("Connexion", style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.black, fontWeight: FontWeight.bold),),
                                        ],
                                      )),
